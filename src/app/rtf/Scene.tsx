...
import { AccumulativeShadows, Environment, Lightformer, OrbitControls, PerspectiveCamera, RandomizedLight, Sphere, useGLTF } from "@react-three/drei";

import React, { useEffect } from "react";
import { DEG2RAD } from "three/src/math/MathUtils";
import { BackSide } from "three";

export const Scene = ({ path, mainColor, ...props }: any) => {
